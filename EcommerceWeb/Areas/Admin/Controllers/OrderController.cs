...
namespace EShopWeb.Areas.Admin.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public IActionResult UpdateOrderDetail()
        {
            ...
            orderHeaderFromDb.StreetName = OrderVM.OrderHeader.StreetName;
        ...
        public IActionResult GetAll(string status)
        {
            ...
            {
                objOrderHeaders = _unitOfWork.OrderHeader.GetAll(includeProperties: "ApplicationUser").ToList(); //Retrieve data
            }
            else
            {
